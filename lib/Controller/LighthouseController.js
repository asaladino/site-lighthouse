...
var _LighthouseService = _interopRequireDefault(require("../Service/LighthouseService"));
...
class LighthouseController {
  ...
  start() {
    ...
    return new Promise((resolve, reject) => {
      ...
      const lighthouseService = new _LighthouseService.default(this.args);
...
exports.default = LighthouseController;
