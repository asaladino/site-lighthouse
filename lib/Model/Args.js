const FileDetails=require("./FileDetails");const path=require("path");const fs=require("fs");/**
 * Commandline arguments being passed to the app.
 */class Args{constructor(params){/**
         ...
         * @type {boolean}
         */this.verbose=true;Object.assign(this,params)}/**
     ...
     */getProjectPath(){let siteName=this.getSiteName();let projectPath=path.join(this.output.filename,siteName);if(!fs.existsSync(projectPath)){fs.mkdirSync(projectPath)}return projectPath}}module.exports=Args;
